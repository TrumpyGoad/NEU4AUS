...
NDefines.NDiplomacy.INTEGRATE_UNION_MIN_YEARS = 20  		-- from 50
...
NDefines.NEconomy.TRADE_NON_CAPITAL_OFFICE = -0.2							-- from 0.5
...
NDefines.NDiplomacy.INTEGRATE_VASSAL_MIN_YEARS = 5 -- from 0 
...
NDefines.NCountry.SCRIPTED_ADVISOR_DISCOUNT = 0.75 -- 0.5
NDefines.NCountry.MAXIMUM_ADVISOR_SKILL = 5-- 5
NDefines.NCountry.PROMOTE_COST_MONTHS_ADVISOR_SALARY = 60.0 -- 60
